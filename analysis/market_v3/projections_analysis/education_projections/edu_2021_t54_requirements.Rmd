---
title: "SHRS Education Analysis — 2021 Entry Requirements & Training (Table 5.4)"
...
if (length(missing) > 0) {
  cat(paste0("> **Missing:** ", paste(soc_xwalk |> filter(soc_code %in% missing) |> pull(shrs_program), collapse = ", "), "\n\n"))
}
```
...
```{r store}
t54_2021_data      <- shrs_t54
t54_2021_scorecard <- shrs_t54 |>
...
cat(paste0("| `t54_2021_data` | Full T5.4 data | ", nrow(t54_2021_data), " x ", ncol(t54_2021_data), " |\n"))
cat(paste0("| `t54_2021_scorecard` | Entry scorecard | ", nrow(t54_2021_scorecard), " x ", ncol(t54_2021_scorecard), " |\n"))
```

**Source:** BLS Table 5.4, 2021 vintage.
