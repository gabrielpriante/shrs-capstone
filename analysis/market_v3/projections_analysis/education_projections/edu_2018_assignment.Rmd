---
title: "SHRS Education Analysis — 2018 Entry Requirements & Training (Assignment)"
...
2018 Assignment uses merged "title and code" header.
...
```{r store}
t54_2018_data <- shrs_t54
t54_2018_scorecard <- shrs_t54 |>
...
cat("| Variable | Dims |\n|---|---|\n")
cat(paste0("| `t54_2018_data` | ",nrow(t54_2018_data),"x",ncol(t54_2018_data)," |\n"))
cat(paste0("| `t54_2018_scorecard` | ",nrow(t54_2018_scorecard),"x",ncol(t54_2018_scorecard)," |\n"))
```

**Source:** BLS Assignment table, 2018 vintage. HIM missing. AT = Bachelor's.
