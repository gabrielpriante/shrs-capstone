---
title: "SHRS Market Analysis — 2022 Labor Force Size & Growth (Table 3.1)"
...
# 5 — Scorecard & Implications

```{r scorecard, results='asis'}
cat(paste0("### Key Benchmarks (",VINTAGE," Vintage)\n\n"))
...
cat(paste0("- <span style='color:#2c7bb6;'>**Current LF:**</span> ",
           format(lf_current, big.mark=","), " thousand\n"))
cat(paste0("- <span style='color:#2c7bb6;'>**Projected LF:**</span> ",
...
```{r store}
lf_t31_2022_raw       <- raw
lf_t31_2022_total     <- total
lf_t31_2022_gender    <- gender
lf_t31_2022_race      <- if(exists("race")) race else NULL
lf_t31_2022_age       <- if(exists("age")) age else NULL
lf_t31_2022_benchmarks <- list(
...
cat(paste0("| `lf_t31_2022_raw` | Full T3.1 (",nrow(raw)," rows) |\n"))
cat("| `lf_t31_2022_total` | Total LF row |\n")
cat("| `lf_t31_2022_benchmarks` | Key benchmarks (list) |\n")
```

**Source:** BLS Table 3.1, 2022 vintage. Projection: 2022–2032.
