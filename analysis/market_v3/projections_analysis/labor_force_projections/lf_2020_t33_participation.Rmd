---
title: "SHRS Market Analysis — 2020 Participation Rates (Table 3.3)"
...
```{r store}
lf_t33_2020_raw       <- raw
lf_t33_2020_total     <- total
lf_t33_2020_gender    <- gender
lf_t33_2020_age       <- if(exists("age")) age else NULL
lf_t33_2020_race      <- if(exists("race")) race else NULL
lf_t33_2020_benchmarks <- list(
...
cat(paste0("| `lf_t33_2020_raw` | Full T3.3 (",nrow(raw)," rows) |\n"))
cat("| `lf_t33_2020_total` | Total LFPR row |\n")
cat("| `lf_t33_2020_benchmarks` | Key benchmarks (list) |\n")
```

**Source:** BLS Table 3.3, 2020 vintage. Projection: 2020-2030.
