---
title: "SHRS Market Analysis — 2023 Labor Force Size & Growth (Table 3.1)"
...
```{r store}
lf_t31_2023_raw       <- raw
lf_t31_2023_total     <- total
lf_t31_2023_gender    <- gender
lf_t31_2023_race      <- if(exists("race")) race else NULL
lf_t31_2023_age       <- if(exists("age")) age else NULL
lf_t31_2023_benchmarks <- list(
...
cat(paste0("| `lf_t31_2023_raw` | Full T3.1 (",nrow(raw)," rows) |\n"))
cat("| `lf_t31_2023_total` | Total LF row |\n")
cat("| `lf_t31_2023_benchmarks` | Key benchmarks (list) |\n")
```

**Source:** BLS Table 3.1, 2023 vintage. Projection: 2023-2033.
