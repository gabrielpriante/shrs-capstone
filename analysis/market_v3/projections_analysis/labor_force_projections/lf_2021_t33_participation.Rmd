---
title: "SHRS Market Analysis — 2021 Participation Rates (Table 3.3)"
...
```{r store}
lf_t33_2021_raw       <- raw
lf_t33_2021_total     <- total
lf_t33_2021_gender    <- gender
lf_t33_2021_age       <- if(exists("age")) age else NULL
lf_t33_2021_race      <- if(exists("race")) race else NULL
lf_t33_2021_benchmarks <- list(
...
cat(paste0("| `lf_t33_2021_raw` | Full T3.3 (",nrow(raw)," rows) |\n"))
cat("| `lf_t33_2021_total` | Total LFPR row |\n")
cat("| `lf_t33_2021_benchmarks` | Key benchmarks (list) |\n")
```

**Source:** BLS Table 3.3, 2021 vintage. Projection: 2021-2031.
