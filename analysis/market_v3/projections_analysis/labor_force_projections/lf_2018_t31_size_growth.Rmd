---
title: "SHRS Market Analysis — 2018 Labor Force Size & Growth (Table 3.1)"
...
CSV_PATH <- file.path(path.expand("~"), "Documents", "SHRS_Analysis",
                       ...
                       "2018_labor-force - Table 3.1.csv")
```

# 1 — Load & Clean

This vintage has a multi-row header — skip 2 rows to reach data.
...
```{r store}
lf_t31_2018_raw <- raw
lf_t31_2018_total <- total
lf_t31_2018_benchmarks <- list(growth_pct=lf_growth_pct, cagr=lf_cagr,
...
cat(paste0("| `lf_t31_2018_raw` | Full data (",nrow(raw)," rows) |\n"))
cat("| `lf_t31_2018_benchmarks` | Key benchmarks (list) |\n")
```

**Source:** BLS Table 3.1, 2018 vintage (2018-2028).
