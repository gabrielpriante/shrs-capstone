---
title: "SHRS Market Analysis — 2021 Labor Force Size & Growth (Table 3.1)"
...
```{r store}
lf_t31_2021_raw       <- raw
lf_t31_2021_total     <- total
lf_t31_2021_gender    <- gender
lf_t31_2021_race      <- if(exists("race")) race else NULL
lf_t31_2021_age       <- if(exists("age")) age else NULL
lf_t31_2021_benchmarks <- list(
...
cat(paste0("| `lf_t31_2021_raw` | Full T3.1 (",nrow(raw)," rows) |\n"))
cat("| `lf_t31_2021_total` | Total LF row |\n")
cat("| `lf_t31_2021_benchmarks` | Key benchmarks (list) |\n")
```

**Source:** BLS Table 3.1, 2021 vintage. Projection: 2021-2031.
