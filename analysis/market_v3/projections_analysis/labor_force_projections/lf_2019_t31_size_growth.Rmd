---
title: "SHRS Market Analysis — 2019 Labor Force Size & Growth (Table 3.1)"
...
CSV_PATH <- file.path(path.expand("~"), "Documents", "SHRS_Analysis",
                       ...
                       "2019_labor-force - Table 3.1.csv")
```
...
```{r store}
lf_t31_2019_raw <- raw
lf_t31_2019_total <- total
lf_t31_2019_benchmarks <- list(growth_pct=lf_growth_pct, cagr=lf_cagr,
...
cat(paste0("| `lf_t31_2019_raw` | Full data (",nrow(raw)," rows) |\n"))
cat("| `lf_t31_2019_benchmarks` | Key benchmarks (list) |\n")
```

**Source:** BLS Table 3.1, 2019 vintage (2019-2029).
