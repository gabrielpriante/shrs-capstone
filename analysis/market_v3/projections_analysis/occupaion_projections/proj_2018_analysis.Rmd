---
title: "SHRS Market Analysis — BLS Projections 2018–2028"
...
The 2018 cycle uses SOC 29-2071 ("Medical records and health information technicians") for HIM — a predecessor code to 29-9021..
...
This vintage uses a 2-row header (merged cells). Skip row 2 and assign column names by position.

```{r load-data}
PROJ_CSV_PATH <- file.path(path.expand("~"), "Documents", "SHRS_Analysis",
                            "market_analysis", "v3data", "projections_csv",
                            "occupation_csv", "occupation_2018.csv")
...
proj |>
  ...
  labs(
    ...
    subtitle = "BLS National Employment Matrix | Pre-COVID baseline",
...
```{r stored-outputs}
proj_2018_data       <- proj
scorecard_2018_data  <- scorecard
benchmark_2018 <- list(cycle = CYCLE, all_occ_growth = all_occ_growth_pct,
                        all_occ_sep_rate = all_occ_sep_rate,
                        all_occ_openings = all_occ_openings)
summary_stats_2018 <- list(
...
program_signals_2018 <- scorecard |>
...
cat("  proj_2018_data, scorecard_2018_data, benchmark_2018\n")
cat("  summary_stats_2018, program_signals_2018, soc_crosswalk_9\n")
...
**Source:** BLS National Employment Matrix, 2018–2028 (`occupation_2018.csv`)

**Context:** This is the **second cycle in our analysis, providing a pre-pandemic baseline.
...
**HIM SOC:** 29-2071.
**Scorecard:** 0–100, 4 dimensions, Green/Yellow/Red.
